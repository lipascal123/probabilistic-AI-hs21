...
class BO_algo(object):
    ...
    def EI(self, x):
        """
        Computes expected improvement according to Equation 2 in
    ...
    def acquisition_function(self, x: np.ndarray) -> np.ndarray:
        ...
        """
        """
        - Exploitation + Exploration -> Expected Improvement Criterion: large for low mean (minimization) and for high variance. 
          Equation 2 in https://www.cs.princeton.edu/~rpa/pubs/gelbart2014constraints.pdf
        """
